 ...
 */
export declare const MENTION_SCHEME_AGENT = "onenat-agent:";
export declare const MENTION_SCHEME_RESOURCE = "onenat-resource:";
export declare const SSH_RESOURCE_PREFIX = "ssh:";
